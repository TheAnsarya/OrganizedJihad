...
/**
 * Parse CLI args for a base URL override.
 *
 * @param {string[]} args - Raw process argv tail
 * @returns {{ baseUrl: string }} Parsed options
 */
 ...
 * @returns {Promise<{ ok: boolean, required: boolean, name: string, status: string }>} Check result
 */
