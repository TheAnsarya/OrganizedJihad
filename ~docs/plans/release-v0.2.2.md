# 🚀 OrganizedJihad v0.2.2 — Release Candidate Notes
...
`v0.2.2` focuses on making installation and first-run setup far more reliable and beginner-friendly.
...
### 1) Installer Elevation-First Flow (NEW in v0.2.2)
...
| Component | Status in v0.2.2 | Notes |
|---|---|---|
...
## 🛠️ Installation / Upgrade Guide (v0.2.2)
...
1. If your browser flags the EXE as unknown/uncommon, click `Keep` -> `Keep anyway`.
2. Right-click `OrganizedJihad.Installer.exe` and open `Properties`.
3. In the General tab, check `Unblock` if shown.
4. Click `Apply`, then `OK`, then run the installer.

Manual userscript setup guide:
...
| Release notes package prepared for v0.2.2 | Engineering | ✅ |

---

## 🎉 Suggested GitHub Release Title

**`v0.2.2` — One-Click Installer Hardening, Admin Elevation Flow, and Release UX Upgrade**

## 📝 Suggested GitHub Release Short Description

**OJ v0.2.2 delivers a stronger single-run install experience with admin-elevation-first setup, a polished Avalonia GUI installer, persisted installer logs, and improved first-run diagnostics/bootstrap guidance for API + Desktop + userscript.**
